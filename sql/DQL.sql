...
(
SELECT
	(SELECT SUM(Suma) FROM V_Bilans_Kwoty WHERE Data BETWEEN '2023-01-01' AND '2023-02-01') AS 'Styczen',
	...
	(SELECT SUM(Suma) FROM V_Bilans_Kwoty WHERE Data BETWEEN '2023-04-01' AND '2023-05-01') AS 'Kwiecien',	
